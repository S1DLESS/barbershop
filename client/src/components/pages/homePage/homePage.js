...
export default function HomePage() {
    ...
    useEffect(() => {
        const instances = window.M.Sidenav.init(document.querySelectorAll('.sidenav'))
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <div className="row">
                    <img className="col s4" src={`${config.serverUrl}/static/homepage/1.jpg`} alt="1"></img>
                    <img className="col s4" src={`${config.serverUrl}/static/homepage/2.jpg`} alt="2"></img>
                    <img className="col s4" src={`${config.serverUrl}/static/homepage/3.jpg`} alt="3"></img>
                </div>
