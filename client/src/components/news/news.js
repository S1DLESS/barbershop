    ...
    return (
        <div className="row">
            <div className="col s3">
                <div className="card">
                    <div className="card-image">
                        <img src={`${config.serverUrl}/static/news/1.webp`} alt='news1'/>
                    </div>
            ...
            <div className="col s3">
                <div className="card">
                    <div className="card-image">
                        <img src={`${config.serverUrl}/static/news/2.webp`} alt='news2'/>
                    </div>
                    <div className="card-content">
            ...
            <div className="col s3">
                <div className="card">
                    <div className="card-image">
                        <img src={`${config.serverUrl}/static/news/3.webp`} alt='news3'/>
                    </div>
                    <div className="card-content">
